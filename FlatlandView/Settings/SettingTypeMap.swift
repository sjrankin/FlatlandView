...
extension Settings
{
    /// Map between a setting type (used as keys into the setting system) and the type of data it stores.
    public static let SettingKeyTypes: [SettingTypes: Any] =
        [
