...
public class Versioning: CustomStringConvertible
{
    ...
    public static let MinorVersion: String = "96"
    ...
    public static let ProgramID = "27647261-0b71-4229-aa7b-3626aa837776"
    ...
    /// Build number.
    public static let Build: Int = 1390
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "3A999669-90FC-4EB0-8A31-632683C48A74"
    
    /// Build date.
    public static let BuildDate: String = "25 June 2020"
    
    /// Build Time.
    public static let BuildTime: String = "20:30"
    ...
    public static func MakeAttributedVersionBlockEx(TextColor: NSColor = NSColor.blue, HeaderColor: NSColor = NSColor.black,
                                                    ...
                                                    FontSize: Double = 24.0) -> NSAttributedString
    {
        ...
        let HeaderFont = NSFont(name: HeaderFontName, size: CGFloat(FontSize))
        let StandardFont = NSFont(name: FontName, size: CGFloat(FontSize))
        ...
        let Line1Attributes: [NSAttributedString.Key: Any] =
            [
                .font: NSFont(name: HeaderFontName, size: CGFloat(FontSize + 4)) as Any,
    ...
    /// - Parameter FontSize: Size of the font.
    /// - Returns: Attributed string with the version block.
    public static func MakeAttributedVersionBlock(TextColor: NSColor = NSColor.blue, HeaderColor: NSColor = NSColor.black,
                                                  FontName: String = "Avenir", HeaderFontName: String = "Avenir-Heavy",
                                                  FontSize: Double = 24.0) -> NSAttributedString
    {
        let Parts = MakeVersionParts()
