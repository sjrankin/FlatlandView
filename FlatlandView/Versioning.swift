...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 5292
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "2D1C3828-CAE9-40C2-ABB8-5874106E5248"
    
    /// Build date.
    public static let BuildDate: String = "23 October 2020"
