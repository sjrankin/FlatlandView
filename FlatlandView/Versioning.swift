...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 6983
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "B54DDA81-9B69-4703-9B56-5C9133771C81"
    
    /// Build date.
    public static let BuildDate: String = "17 December 2020"
