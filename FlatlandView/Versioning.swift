...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 4080
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "064F73DA-5A43-4401-A3F8-1B1BC3002131"
    
    /// Build date.
    public static let BuildDate: String = "23 September 2020"
    
    /// Build Time.
    public static let BuildTime: String = "20:48"
