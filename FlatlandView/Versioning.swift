...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 7411
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "71059B7B-9C10-44B6-94EE-64D4ACE67078"
    
    /// Build date.
    public static let BuildDate: String = "9 January 2021"
