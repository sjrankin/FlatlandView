...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 8649
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "E84F5FD1-44F2-4629-AA21-A8AC22BB9CEF"
    
    /// Build date.
    public static let BuildDate: String = "19 February 2021"
    
    /// Build Time.
    public static let BuildTime: String = "21:26"
