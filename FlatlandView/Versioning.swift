...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 7074
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "3526FD44-EF87-48D7-BAFB-D40F0D269150"
    
    /// Build date.
    public static let BuildDate: String = "24 December 2020"
