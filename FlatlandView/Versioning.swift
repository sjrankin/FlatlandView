...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 7571
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "F6DD4774-2E59-4876-B8CC-DE0EABDA16F1"
    
    /// Build date.
    public static let BuildDate: String = "15 January 2021"
