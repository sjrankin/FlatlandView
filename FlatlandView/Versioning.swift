...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 1589
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "00E906CB-EF7B-4820-A38D-3B7A59ADBA01"
    
    /// Build date.
    public static let BuildDate: String = "2 July 2020"
    
    /// Build Time.
    public static let BuildTime: String = "17:00"
