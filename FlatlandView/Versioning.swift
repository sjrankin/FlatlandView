...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 4792
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "6F5003C3-8943-4096-A802-57927DFFF6ED"
    
    /// Build date.
    public static let BuildDate: String = "11 October 2020"
