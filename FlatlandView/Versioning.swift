...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 7485
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "AA2C9048-5B67-4518-BE86-A720E90075ED"
    
    /// Build date.
    public static let BuildDate: String = "11 January 2021"
    
    /// Build Time.
    public static let BuildTime: String = "17:59"
