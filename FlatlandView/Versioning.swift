...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 8419
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "699B945D-2EDB-4023-9A70-A3493A13D172"
    
    /// Build date.
    public static let BuildDate: String = "15 February 2021"
    
    /// Build Time.
    public static let BuildTime: String = "15:42"
