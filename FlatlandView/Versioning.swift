...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 8909
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "1EC2D09B-5A11-4682-BFA3-AB09BDB812B9"
    
    /// Build date.
    public static let BuildDate: String = "5 March 2021"
    
    /// Build Time.
    public static let BuildTime: String = "11:17"
