...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 5111
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "721A9467-F100-490A-AD30-6E50E00368B4"
    
    /// Build date.
    public static let BuildDate: String = "20 October 2020"
    
    /// Build Time.
    public static let BuildTime: String = "18:07"
