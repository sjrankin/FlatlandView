...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 2003
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "69591909-3DB9-465B-942B-13FEF0E2166C"
    
    /// Build date.
    public static let BuildDate: String = "16 July 2020"
    
    /// Build Time.
    public static let BuildTime: String = "15:33"
