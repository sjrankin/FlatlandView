...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 5053
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "075179D6-0999-4A98-938C-2D6C7D9804EE"
    
    /// Build date.
    public static let BuildDate: String = "19 October 2020"
    
    /// Build Time.
    public static let BuildTime: String = "14:09"
