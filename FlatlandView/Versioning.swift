...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 3226
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "4B374740-3496-4A94-B3BB-9BA1B2FFE2AC"
    
    /// Build date.
    public static let BuildDate: String = "3 September 2020"
    
    /// Build Time.
    public static let BuildTime: String = "13:48"
