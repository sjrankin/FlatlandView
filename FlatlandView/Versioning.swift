...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 4819
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "0BB0C687-B156-40C5-8433-CFCAA1F2FCED"
    
    /// Build date.
    public static let BuildDate: String = "12 October 2020"
    
    /// Build Time.
    public static let BuildTime: String = "16:31"
